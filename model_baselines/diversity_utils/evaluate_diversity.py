...
def main(args):
    ...
    try:
        assert type(eval(dat[0])) == dict 
        print('performing dict casting')
        print(dat[0])
        dat = [eval(i)['text_predicted'] for i in dat] 
        # print(dat[:5])
    except:
        pass
...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_key', type=str, default='text_predicted',
